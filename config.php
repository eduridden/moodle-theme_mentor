...
$sidebar['frontpage'] = get_config('theme_mentor', 'frontpagesidebar');
if(!in_array($sidebar['frontpage'], $frontpageArray)){
    $sidebar['frontpage'] = "";
}

$generalArray = array("side-pre","side-post");
$sidebar['general'] = get_config('theme_mentor', 'generalsidebar');
...
$THEME->csspostprocess = 'mentor_process_css';
