...
<head>
    ...
    <noscript>
        <link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot;?>/theme/mentor/css/nojs.css" />
    </noscript>
</head>
<body>
                ...
                <div class="loginbox">
                    <form method="post"  action="<?php echo $CFG->wwwroot; ?>/login/index.php">
                        <div class="leftarea">
                            ...
                            <a href="forgot_password.php" style="float: right;">Forgot username or password</a>
                        </div>
