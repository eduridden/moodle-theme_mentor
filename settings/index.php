<?php
    ...
    $menudata           = json_decode(get_config("theme_mentor","menudata"));
    ...
    #Links
    $footermod_links             = json_decode(get_config('theme_mentor','footermod_links'));
    #Contact Info
    ...
    $slideshowdata               = json_decode(get_config('theme_mentor','slideshowdata'));
    ...
    $featuredcourses             = json_decode(get_config('theme_mentor','featuredcourses'));
    $showlinkboxes               = get_config('theme_mentor','showlinkboxes');
    $linkboxdata                 = json_decode(get_config('theme_mentor','linkboxdata'));
    ...
    $PAGE->set_url($CFG->wwwroot."/theme/mentor/settings/index.php");
    echo $OUTPUT->header();
